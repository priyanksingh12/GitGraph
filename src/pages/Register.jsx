...
/* ── Panel-Specific Foreground Canvas ── */
...
const Register = () => {
  ...
  // Preserved exactly as originally provided
  ...
  return (
   <div className="relative min-h-screen bg-[#020617] flex items-center justify-center p-4 sm:p-8 font-sans selection:bg-cyan-500/40 overflow-hidden">
...
<div className="hidden md:flex flex-col relative overflow-hidden bg-[#020617]/50 border-r border-white/10 min-h-[600px] z-10">
        ...
        {/* ── Right: Form Panel ── */}
        <div className="flex flex-col justify-center px-8 py-10 sm:px-16 lg:px-20 relative z-10 bg-[#020617]/40 backdrop-blur-2xl">
          <div className="w-full max-w-sm mx-auto">
            ...
            <form className={`space-y-4 transition-all duration-1000 delay-500 ease-out ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} onSubmit={handleSubmit}>
              ...
              <div className="group relative">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/10 bg-[#020617]/60 px-5 py-3.5 text-sm text-white placeholder-slate-500 backdrop-blur-xl transition-all focus:border-cyan-500/50 focus:outline-none focus:ring-1 focus:ring-cyan-500/50"
                    required
                  />
                </div>
              </div>
              ...
              <div className="group relative">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/10 bg-[#020617]/60 px-5 py-3.5 pr-12 text-sm text-white placeholder-slate-500 backdrop-blur-xl transition-all focus:border-cyan-500/50 focus:outline-none focus:ring-1 focus:ring-cyan-500/50"
                    required
                  />
                  <div
